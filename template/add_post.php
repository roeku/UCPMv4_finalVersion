...
<?php
	...
	postEvent($userID, $title, $location, $start, $end, $invitee, $label, $secret);
	if ($invitee!=0){
		postEvent($invitee, $title, $location, $start, $end, $userID, $label, $secret);
	}
	echo '<p class="succes">Event successfully created.</p>';
