...
<div class="calendar">
	<div class="calendarheader">
		<a href="?month=<?php echo $month-1;?>&year=<?php echo $year?>&id=<?php echo $userID?>"><div class="prev">&laquo;</div></a>
		<a href="?day=<?php echo $curday;?>&month=<?php echo $curmonth?>&year=<?php echo $curyear?>"><div class="titlemonth"><?php echo $title.' '.$year; ?></div></a>
		<a href="?month=<?php echo $month+1;?>&year=<?php echo $year?>&id=<?php echo $userID?>"><div class="next">&raquo;</div></a>
	</div>
	<div class="daysrow">
...
<div class="planning thisday">
	<ul>
		<?php getAllAppointments($day, $month, $year, $userID); ?>
	</ul>
</div>
